...
**Task management app** is an application that allows users to 
create, update, read, and delete tasks as well as mark tasks as `done` or `Not done` by making calls to the open API
